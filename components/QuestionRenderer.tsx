...
import { shuffleArray, createQuestionIssueUrl } from '@/lib/utils';
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="mt-4 flex items-center gap-4">
        ...
        <a
          href={createQuestionIssueUrl(question)}
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2 text-xs font-medium text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-colors ml-auto"
          title="Report an issue with this question on GitHub"
        >
          <svg 
            className="w-4 h-4" 
            fill="none" 
      ...
      {showCorrect && question.explanation && showExplanation && (
