...
export const CATEGORY_DESCRIPTIONS: Record<string, string> = {
  ...
  es2025: 'ECMAScript 2025 features: Iterator helpers, Set methods, JSON modules, RegExp enhancements, Promise.try(), and Float16Array',
...
export const CATEGORY_ICONS: Record<string, string> = {
  ...
  es2025: 'M13 10V3L4 14h7v7l9-11h-7z', // Lightning bolt (new features)
};
